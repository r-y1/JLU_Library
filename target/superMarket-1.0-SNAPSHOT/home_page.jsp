...
<div class="banner">
    <div class="container">
        ...
        <p>今日精选推荐</p>
        <a class="banner_a" href="javascript:;" onclick="buy(${scroll.id})">立刻借阅</a>
...
<div class="gallery">
    <div class="container">
<%--    热门是图书推荐板块    --%>
        <div class="alert alert-danger">热门图书推荐</div>
        <div class="gallery-grids">
            <c:forEach items="${hotList}" var="g">
                <div class="col-md-4 gallery-grid glry-two">
                    <a href="<%=request.getContextPath()%>/goods_detail?id=${g.id}">
                        <img  style="width:350px;height:200px" src="<%=request.getContextPath()%>/${g.cover}" class="img-responsive" alt="${g.name}" width="350" height="350"/>
                    </a>
                    <div class="gallery-info galrr-info-two">
                        ...
                        <a class="shop" href="javascript:;" onclick="buy(${g.id})">立刻借阅</a>
        ...
        <div class="gallery-grids">
            <c:forEach items="${newList}" var="g">
                <div class="col-md-3 gallery-grid ">
                    <a href="<%=request.getContextPath()%>/goods_detail?id=${g.id}">
                        <img  style="width:350px;height:200px" src="<%=request.getContextPath()%>/${g.cover}" class="img-responsive" alt="${g.name}"/>
                    </a>
