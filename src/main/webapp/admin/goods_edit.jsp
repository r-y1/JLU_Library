...
<div class="container-fluid">
	...
	<form class="form-horizontal" action="<%=request.getContextPath()%>/admin/goods_edit" method="post" enctype="multipart/form-data">
		...
		<div class="form-group">
			...
			<div class="col-sm-6">
				<input type="text" class="form-control" id="input_name1" name="name" value="${g.name }" required="required">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-6">
				<input type="text" class="form-control" id="input_name2" name="price" value="${g.price }">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-6">
				<input type="text" class="form-control" id="input_name3" name="intro" value="${g.intro }">
			</div>
		</div>

		<div class="form-group">
			<label for="input_name4" class="col-sm-1 control-label">正版存量</label>
			<div class="col-sm-6">
				<input type="text" class="form-control" id="input_name4" name="stock" value="${g.stock }">
			</div>
		</div>
